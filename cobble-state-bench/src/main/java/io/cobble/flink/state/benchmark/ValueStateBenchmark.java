...
/** Implementation for value state benchmark testing. */
public class ValueStateBenchmark extends StateBenchmarkBase {
    ...
    public void setUp() throws Exception {
        ...
        valueState =
                StateBackendBenchmarkUtils.getValueState(
                        keyedStateBackend, new ValueStateDescriptor<>("kvState", Long.class));
    ...
    @Benchmark
    public void valueUpdate(KeyValue keyValue) throws Exception {
        keyedStateBackend.setCurrentKey(keyValue.setUpKey);
        valueState.update(keyValue.value);
    }

    @Benchmark
    public void valueAdd(KeyValue keyValue) throws Exception {
