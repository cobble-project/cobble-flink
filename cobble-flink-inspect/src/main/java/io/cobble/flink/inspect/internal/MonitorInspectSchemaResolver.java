 ...
 */
public final class MonitorInspectSchemaResolver {
    ...
    public static Path checkpointRoot(CheckpointEntry checkpoint) {
        Path checkpointDir =
                new Path(InspectPathUtils.normalizeStorageDirectory(checkpoint.directory));
    ...
    private static String pathToStorageString(Path path) {
        return InspectPathUtils.pathToStorageString(path);
    }
}
