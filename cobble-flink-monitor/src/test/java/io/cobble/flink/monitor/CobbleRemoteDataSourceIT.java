...
class CobbleRemoteDataSourceIT {
    ...
    @Test
    void discoversCatalogAndSinkSchemaWithConnectorOnlyS3Options() throws Exception {
        ...
        try {
            ...
            CobbleFlinkMonitorServer.CheckpointCatalog catalog =
                    CobbleFlinkMonitorServer.CheckpointCatalog.discover(root, options);
            ...
            assertEquals(7L, catalog.checkpoints.get(0).id);
