 ...
 * 2.0.2 classes. Verifies that the reflection-based extraction of POJO field names, field order,
 * and registered-subclass tag ordering works correctly with Flink 2.0's {@code SerializerConfig}.
 *
