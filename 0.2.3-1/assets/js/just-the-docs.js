...
function initSearch() {
  ...
  request.open('GET', '/cobble-flink/0.2.3-1/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/cobble-flink/0.2.3-1/assets/css/just-the-docs-' + theme + '.css');
}
