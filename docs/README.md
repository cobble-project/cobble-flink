...
2. Create and push a release tag such as `v0.4.0-1`.
3. The workflow publishes the tagged sources to `0.4.0-1/` on `gh-pages`.
...
- `https://cobble-project.github.io/cobble-flink/0.4.0-1/`
