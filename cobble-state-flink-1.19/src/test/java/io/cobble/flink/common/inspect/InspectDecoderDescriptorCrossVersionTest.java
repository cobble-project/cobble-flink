 ...
 * 1.19.3 classes. Verifies that the reflection-based extraction of POJO field names, field order,
 * and registered-subclass tag ordering works correctly across Flink versions.
 *
